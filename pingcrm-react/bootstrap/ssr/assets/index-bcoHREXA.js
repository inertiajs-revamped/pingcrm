...
const Index = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Organizations" }),
    /* @__PURE__ */ jsx("h1", { className: "mb-8 text-3xl font-bold", children: "Organizations" }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsx(SearchFilter, {}),
      /* @__PURE__ */ jsxs(Link, { className: "btn-indigo", href: "/organizations/create", children: [
        /* @__PURE__ */ jsx("span", { children: "Create" }),
        /* @__PURE__ */ jsx("span", { className: "hidden md:inline", children: " Organization" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-md shadow overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full whitespace-nowrap", children: [
      ...
      /* @__PURE__ */ jsxs("tbody", { children: [
        data.map(({ id, name, phone, city, deleted_at }) => /* @__PURE__ */ jsxs(
          "tr",
          {
        ...
        data.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { className: "px-6 py-4 border-t", colSpan: 4, children: "No organizations found." }) })
      ] })
    ] }) }),
